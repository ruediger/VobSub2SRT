ADDED --tesseract-oem option to vobsub2srt for use with Tesseract 4. Generally I use --tesseract-oem 1 with the following tesseract 4 traindata:
https://github.com/tesseract-ocr/tesseract/wiki/Data-Files

This reduced my OCR erros significantly. 
